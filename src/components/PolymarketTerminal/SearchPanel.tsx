      ...
      <div className="px-3 py-2">
        <form onSubmit={handleSubmit} className="relative">
          <input
            ...
            className="w-full bg-black border border-green-500/40 text-green-400 px-2 py-1.5 text-[10px] font-mono focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 placeholder:text-green-600/40 pr-16"
          />
          <div className="absolute right-1 top-1/2 -translate-y-1/2 flex gap-1">
            {query && (
              <button
                type="button"
                onClick={handleClear}
                className="text-green-500/60 hover:text-green-400 text-[9px] px-1"
              >
                Clear
              </button>
            )}
            <button
              type="submit"
              className="text-green-500/80 hover:text-green-400 text-[9px] px-1"
            >
              Search
            </button>
          </div>
