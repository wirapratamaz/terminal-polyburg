...
export const CHANNEL = "ELEMENT_HOVER_v1" as const;
const VISUAL_EDIT_MODE_KEY = "element_visual_edit_mode" as const;
const FOCUSED_ELEMENT_KEY = "element_focused_element" as const;
...
const postMessageDedup = (data: any) => {
  try {
    ...
    if (key === _elementLastMsg) return; // identical – drop
    _elementLastMsg = key;
  } catch {
...
export default function HoverReceiver() {
  ...
  useEffect(() => {
    function handleMessage(e: MessageEvent) {
      if (e.data?.type === "ELEMENT_STYLE_UPDATE") {
      ...
      } else if (e.data?.type === "ELEMENT_IMAGE_UPDATE") {
